...
class OneOneCollectionViewCell: UICollectionViewCell,MyFileDownloaderDelegate {
    ...
    func processData(items : [NSDictionary]){
        ...
        print("storySubArray = \(String(describing: self.storySubArray))")
    ...
    @IBAction func buttonPressed(_button : UIButton){
        ...
        print("buttonPressed : \(_button.tag)")
